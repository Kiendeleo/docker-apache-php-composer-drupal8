...
RUN sed -i "s/short_open_tag = Off/short_open_tag = On/" /etc/php7.2/apache2/php.ini
RUN sed -i "s/error_reporting = .*$/error_reporting = E_ERROR | E_WARNING | E_PARSE/" /etc/php7.2/apache2/php.ini
